...
export const StickyScrollReveal = ({
  ...
  images
    ...
    return (
        ...
        className="h-[50rem] overflow-y-auto no-scrollbar flex justify-center relative space-x-10 rounded-md p-10"
        ref={ref}
        >
        ...
        <motion.div
            ...
            className={cn(
            "hidden lg:block h-[40rem] w-[40rem] rounded-md bg-white sticky top-10 overflow-hidden",
            contentClassName
            )}
        >
